...
export const flex_idx_search_filter = {
  updateEventUri: 'https://api.idxboost.dev/events/collections',
  rk: 'c4e7eb8a91f97e02fe6e610a022438adb97088fc',
  wp_web_id: '148',
  ajaxUrl: 'https://idxbrentalsdev.wpengine.com/wp-admin/admin-ajax.php',
  hackbox: {
    status: true,
  ...
  agentPhone: '7894561230',
  lookupSearchFilter: 'https://api.idxboost.dev/search_filter_lookup',
  lookupSearchCommercialFilter:
    'https://api.idxboost.dev/search_commercial_filter_lookup',
  lookupListingsDetail: 'https://api.idxboost.dev/listings/{{mlsNumber}}',
  trackListingsDetail: 'https://api.idxboost.dev/listings/{{mlsNumber}}/track',
  saveListings: 'https://api.idxboost.dev/listings/{{filterId}}/save',
  shareWithFriendEndpoint: 'https://api.idxboost.dev/sharing/{{mlsNumber}}',
  requestInformationEndpoint: 'https://api.idxboost.dev/inquiry/{{mlsNumber}}',
  requestDataOffmarket:
    'https://api.idxboost.dev/lookup_get_off_market_listing_for_item',
  propertyDetailPermalink: 'https://idxbrentalsdev.wpengine.com/property',
  lookupAutocomplete: 'https://autocomplete.idxboost.dev',
  accessToken:
    'YTMwN2M5ZDc3ZTcxNTNjOGUxZTU2YTQ5ZWM1NzBhN2UzOWRhYTg2MzM5MjA0N2YwMjMzMzU0N2QzNDYzMzMxMQ',
  boardId: '1',
  search: {
...
export const initializeElement = () => {
  ...
  jQuery(document).on('click', '.js-show-modals-save', function (e) {
    e.preventDefault()
